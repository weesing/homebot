...
import {
    ...
    CMD_GENERATE_UUID,
    CMD_CAMERA_SNAPSHOT,
    CMD_CAMERA_CHECKPOINT_LIVE_CAMS,
    CMD_TOGGLE_DOORLOCK,
    CMD_DOORLOCK_STATUS,
    CMD_DOORLOCK_REBOOT,
    CMD_RFID_REBOOT,
...
import { HandlerCheckpointLiveCams } from "./handler_checkpointlivecams";
...
export class HandlerMenu extends HandlerBase {
    ...
    handleMenuCallback(context) {
        ...
        switch (command) {
            ...
            case CMD_CAMERA_CHECKPOINT_LIVE_CAMS: {
                this.handleCameraSnapshot(context);
                break;
            }
    ...
    async handleCameraSnapshot(context) {
        const handlerCheckpointLiveCams = new HandlerCheckpointLiveCams({
            botInstance: this.botInstance,
        });
        await handlerCheckpointLiveCams.handleMessage(context);
    }
        ...
        return JSON.stringify({
            inline_keyboard: [
                ...
                [
                    ...
                    {
                        text: `${AssetDefines.cameraSnapshotIcon} LTA Live Cams`,
                        callback_data: JSON.stringify({
                            command: CMD_CAMERA_CHECKPOINT_LIVE_CAMS,
                        }),
                    },
                ],
                [
